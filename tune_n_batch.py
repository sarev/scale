...
It reloads the model for each candidate n_batch, measures tokens/sec on a short completion, and stops when throughput
drops beyond a tolerance or an error occurs (e.g. CUDA OOM). The best n_batch and a summary table are printed.
